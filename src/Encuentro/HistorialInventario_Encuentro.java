 ...
 * @author jluis
 */
public class HistorialInventario_Encuentro extends javax.swing.JInternalFrame {
     ...
     */
    public HistorialInventario_Encuentro() {
        initComponents();
        ListarProductos();
    }
    ...
    private void ActualizarInventario() {
        ...
        PreparedStatement sm = null;
        try {
            sm = con.prepareStatement("update consumos c,productos_inventario p set c.CantidadInicial = p.cantidad,estado = 1 where c.Codigo = p.codigo and c.fecha = '" + Fechaout + "'");
            sm.executeUpdate();
            con.close();
            sm.close();
            JOptionPane.showMessageDialog(null, "INICIO DE INVENTARIO AGREGADO");
    ...
    private void ListarHistorial() {
        ...
        ArrayList<Productos> result = BDProductos_Encuentro.ListarProductosHistorialInventario(FechaListar);
        Lista(result);
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("HISTORIAL INVENTARIO ENCUENTRO");
        ...
        jLabel2.setText("CANTIDADES ACTUALES EN SISTEMA MAQUINA ENCUENTRO");
