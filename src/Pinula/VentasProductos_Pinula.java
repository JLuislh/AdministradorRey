...
public class VentasProductos_Pinula extends javax.swing.JPanel {
    ...
    private void ListarProductosVedidos(){
        ...
        ArrayList<InsertarProducto> result = BDProductos_Pinula.ProductosVendidos(Fecha);
     ...
     private void RecargarTablaDetallado(ArrayList<InsertarProducto> list) {
      ...
      private void ListarConsumoCarnes(){
        ...
        ArrayList<InsertarProducto> result = BDProductos_Pinula.ConsumoCarnes(Fecha);
        Carnes(result);  
    }
     ...
     private void ListarTodosProductosVedidos(){
        ...
        ArrayList<InsertarProducto> result = BDProductos_Pinula.TodosProductosVendidos(Fecha);
        Todos(result);  
    }
