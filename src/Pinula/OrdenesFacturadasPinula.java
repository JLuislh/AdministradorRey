 ...
 * @author Jorge Lopez
 */
public class OrdenesFacturadasPinula extends javax.swing.JInternalFrame {
   int id_orden;
    /**
     * Creates new form OrfenesFacturadas
     */
    public OrdenesFacturadasPinula() {
        initComponents();
    }
    ...
    public void ListarFacturasGeneradas(){
        ...
        ArrayList<ObtenerProductosFactura> result = ObtenerProductosFactura.ListarFacturasGeneradasPinula(fecha);
     ...
     public void sumaTotalFacturado() {
      ...
      public  void ListarProductosPedidos(){
        ...
        ArrayList<InsertarProducto> result = BDProductos_Encuentro.ListarProductosPedidosPinula(id_orden);
        Recarga(result);  
    }
