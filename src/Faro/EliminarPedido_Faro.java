 ...
 * @author jluis
 */
public class EliminarPedido_Faro extends javax.swing.JPanel {
    int tipo;
    int opcion;
     ...
     */
    public EliminarPedido_Faro() {
        initComponents();
    }
    
    public  void ListarProductosPedidos(){
        
        ArrayList<InsertarProducto> result = BDProductos_Faro.ListarProductosPedidos(Integer.parseInt(Pedido.getText()));
