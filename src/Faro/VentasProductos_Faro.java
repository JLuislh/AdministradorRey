 ...
 * @author jluis
 */
public class VentasProductos_Faro extends javax.swing.JPanel {
    String Fecha;
    /**
     * Creates new form VentasProductos_Encuentro
     */
    public VentasProductos_Faro() {
        initComponents();
    }
    ...
    private void ListarProductosVedidos(){
        ...
        ArrayList<InsertarProducto> result = BDProductos_Faro.ProductosVendidos(Fecha);
     ...
     private void RecargarTablaDetallado(ArrayList<InsertarProducto> list) {
      ...
      private void ListarConsumoCarnes(){
        ...
        ArrayList<InsertarProducto> result = BDProductos_Faro.ConsumoCarnes(Fecha);
        Carnes(result);  
    }
     ...
     private void ListarTodosProductosVedidos(){
        ...
        ArrayList<InsertarProducto> result = BDProductos_Faro.TodosProductosVendidos(Fecha);
        Todos(result);  
    }
