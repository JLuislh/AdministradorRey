 ...
 * @author jluis
 */
public class HistorialInventario_Faro extends javax.swing.JPanel {
    String Fechain;
    String Fechaout; 
    String FechaListar; 
     ...
     */
    public HistorialInventario_Faro() {
        initComponents();
        ListarProductos();
    }
    ...
    private void ListarHistorial() {
        ...
        ArrayList<Productos> result = BDProductos_Faro.ListarProductosHistorialInventario_Faro(FechaListar);
        Lista(result);
    }
